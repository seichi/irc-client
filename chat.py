...
#signals and slots connection
    ...
    def retranslateUi(self, chat):
        chat.setWindowTitle(QtGui.QApplication.translate("chat", "Form", None, QtGui.QApplication.UnicodeUTF8))
